...
+ (id)constantWithCode:(OSType)code_ {
    switch (code_) {
        ...
        case 'pRlD': return [self releaseDate];
...
+ (ITConstant *)Books {
    ...
    if (!constantObj)
        constantObj = [ITConstant constantWithName: @"Books" type: typeEnumerated code: 'kSpA'];
    return constantObj;
}
...
+ (ITConstant *)Genius {
    static ITConstant *constantObj;
    if (!constantObj)
        constantObj = [ITConstant constantWithName: @"Genius" type: typeEnumerated code: 'kSpG'];
    return constantObj;
}
...
+ (ITConstant *)Library {
    static ITConstant *constantObj;
    if (!constantObj)
        constantObj = [ITConstant constantWithName: @"Library" type: typeEnumerated code: 'kSpL'];
    return constantObj;
}
...
+ (ITConstant *)all {
    static ITConstant *constantObj;
    if (!constantObj)
        constantObj = [ITConstant constantWithName: @"all" type: typeEnumerated code: 'kAll'];
    return constantObj;
}
...
+ (ITConstant *)iTunesU {
    static ITConstant *constantObj;
    if (!constantObj)
        constantObj = [ITConstant constantWithName: @"iTunesU" type: typeEnumerated code: 'kSpU'];
    return constantObj;
}
...
+ (ITConstant *)none {
    static ITConstant *constantObj;
    if (!constantObj)
        constantObj = [ITConstant constantWithName: @"none" type: typeEnumerated code: 'kNon'];
    return constantObj;
}
...
+ (ITConstant *)releaseDate {
    static ITConstant *constantObj;
    if (!constantObj)
        constantObj = [ITConstant constantWithName: @"releaseDate" type: typeType code: 'pRlD'];
    return constantObj;
}
